...
class HomeViewTest(TestCase):
    def setUp(self):
        ...
        self.tech_stack = TechStack.objects.create(name='Django', category=self.category, image_url='http://example.com/django.png')
    ...
    def test_home_view(self):
        ...
        self.assertIn(self.tech_stack, response.context['tech_stack_categories'][0].tech_stacks.all())
